...
def _state(mode: str, started_at: float) -> StreamState:
    return StreamState("s", "cam-1", "rtsp://127.0.0.1/live", 2.0, "示范工区", True, mode, 300, started_at=started_at)
...
def test_first_inspection_waits_for_warmup_then_repeats_by_interval():
    ...
    short = StreamState("s2", "cam-2", "rtsp://127.0.0.1/live", 2.0, "示范工区", True, "realtime", 3, started_at=2000.0)
